...
public class Principal extends javax.swing.JFrame {
    ...
    public Principal() {
        ...
        //Ponemos el icono 
        ImageIcon icono = new ImageIcon("src/Imagenes/icono.ico");
    ...
    private void initComponents() {
        ...
        jMenuMante = new javax.swing.JMenu();
        jMenuItemPro = new javax.swing.JMenuItem();
        jMenuItemCLIE = new javax.swing.JMenuItem();
        ...
        jMenuItemBoletas = new javax.swing.JMenuItem();
        ...
        jMenuMante.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/mantenimiento.jpg"))); // NOI18N
        jMenuMante.setText("Mantenimiento");
        jMenuMante.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuManteActionPerformed(evt);
            }
        });

        jMenuItemPro.setText("Productos");
        jMenuItemPro.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemProActionPerformed(evt);
            }
        });
        jMenuMante.add(jMenuItemPro);

        jMenuItemCLIE.setText("Clientes");
        jMenuItemCLIE.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemCLIEActionPerformed(evt);
            }
        });
        jMenuMante.add(jMenuItemCLIE);

        jMenuBar1.add(jMenuMante);
        ...
        jMenu5.add(jMenuItemFacturas);

        jMenuItemBoletas.setText("Boletas");
        jMenuItemBoletas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemBoletasActionPerformed(evt);
            }
        });
        jMenu5.add(jMenuItemBoletas);
...
private void jMenuManteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuManteActionPerformed
// TODO add your handling code here:

}//GEN-LAST:event_jMenuManteActionPerformed

private void jMenuItemCLIEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemCLIEActionPerformed
// TODO add your handling code here:
    IngresoCliente cli = new IngresoCliente();
    jdpescritorio.add(cli);
    cli.show();
}//GEN-LAST:event_jMenuItemCLIEActionPerformed
...
// TODO add your handling code here:
    ...
    try {
        ...
        JasperReport reportes = (JasperReport) JRLoader.loadObjectFromFile("src\\Formulario\\reportesClientes.jasper");
...
// TODO add your handling code here:
    ...
    try {
        conectar cc = new conectar();
        JasperReport reportes = (JasperReport) JRLoader.loadObjectFromFile("src\\Formulario\\reportesProductos.jasper");
        JasperPrint print = JasperFillManager.fillReport(reportes, null, cc.conexion());
        JasperViewer view = new JasperViewer(print, false);
        //Para evitar que se quede la hoja de reportes
...
// TODO add your handling code here:
    ...
    try {
        conectar cc = new conectar();
        JasperReport reportes = (JasperReport) JRLoader.loadObjectFromFile("src\\Formulario\\reportesFacturas.jasper");
        JasperPrint print = JasperFillManager.fillReport(reportes, null, cc.conexion());
        JasperViewer view = new JasperViewer(print, false);
        //Para evitar que se quede la hoja de reportes
...
private void jMenuItemBoletasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemBoletasActionPerformed
// TODO add your handling code here:

    try {
        conectar cc = new conectar();

        JasperReport reportes = (JasperReport) JRLoader.loadObjectFromFile("src\\Formulario\\reportesBoletas.jasper");
        JasperPrint print = JasperFillManager.fillReport(reportes, null, cc.conexion());
        JasperViewer view = new JasperViewer(print, false);
        //Para evitar que se quede la hoja de reportes
...
}//GEN-LAST:event_jMenuItemBoletasActionPerformed
    ...
    private javax.swing.JMenuItem jMenuItemBoletas;
    private javax.swing.JMenuItem jMenuItemCLIE;
    ...
    private javax.swing.JMenu jMenuMante;
