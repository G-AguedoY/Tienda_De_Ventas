...
public class Boleta extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TIENDA SALE");

        jLabel3.setText("DE:AGUEDO YANAC GERSON JOFRE");

        jLabel4.setText("Carr. Wilcahuain S/N ");

        jLabel5.setText("Telf: 978177398");

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/productos.jpg"))); // NOI18N
        jLabel7.setText("jLabel7");

        jLabel16.setText("Independencia - Huaraz");
